...
|---|---|---|---|
| f01 | `features/f01-urdu-core-foundation.md` | 🟡 in progress (s01–s05 done; s06/s07 next) | Repo, shared domain rules, D1 schema, unlock auth, vocab/review API, PWA shell. |
