...
**Status**: 🟡 IN PROGRESS — opened 2026-09-14; Stage 0 (research + build) cleared; Stages 1–2 gated on the sponsor's OpenAI key and phone
**Handle**: `mp02`
...
- **OpenAI API credit (sponsor).** Decision 260911a records that the sponsor has no paid API credits and ChatGPT Plus includes none. This spike needs a funded OpenAI API key: roughly $1–2 of prepaid credit covers the desktop check plus the ten-minute run. Sponsor to confirm they will fund it before s04; without it the spike cannot run and Option 1 ships by default (Appendix D: any criterion unmet → Option 1).
