...
- f11 `vocab-check` — 🟡 IN PROGRESS, s00 planning (opened 2026-09-23): questions settled, stress-test next; brings migration 0004 → `features/f11-vocab-check.md`

## Next Session Pointers
*The 1–3 concrete next actions for a cold start.*

1. **f11 `vocab-check`**: `/pm-stress-test f11`, then s01 (migration 0004 `checked_at`, batch route, corrections route). The sponsor must apply 0004 remotely before the deploy that carries it.
