...
1. **Next deploy**: carries the two f06 polish fixes (ChatGPT buttons above the Vocab list; fill-in recount after save) — glance at both on the phone (TODO). Settings › About shows the deployed commit to match against `git log`.
