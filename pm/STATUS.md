...
4. **f07 `coach-client`** drafted, questions settled (260918h): `/pm-stress-test`, `/pm-open`, then s01–s02 (broker + tools) need no sponsor. Inbox empty. Toolchain: AVG Hardened Mode + CyberCapture off; never add exceptions.
