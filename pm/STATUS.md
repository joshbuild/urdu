...
- f05 `review` — 🟡 IN PROGRESS, s01 next → `features/f05-review.md`

## Next Session Pointers
*The 1–3 concrete next actions for a cold start.*

1. **f05 `review` open** — build s01–s04 per the doc (FR-E1..E4; session limit already in Settings via `src/settings/sessionLimit.ts`). Then f08 `vocab-enrich`.
