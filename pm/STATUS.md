...
- f05 `review` — 🟡 IN PROGRESS, built; smoke-test-05 all green 2026-09-22, awaiting `/pm-close` → `features/f05-review.md`
...
1. **f05 `review`**: smoke-test-05 is all green (2026-09-22), F5 confirmed the D2 colour fix. Next: `/pm-close`.
